  ...
  return (
    <div className="min-h-screen my-20 md:my-32 px-3 md:px-8 lg:px-16 text-center">
      <div className="max-w-3xl mx-auto space-y-6 ">
        <H1>Gondar Car Rentals Policies</H1>
        <p>
          At Gondar Car Rentals, we are committed to providing our customers
          with a seamless and enjoyable rental experience. Please take a moment
          to review our policies outlined below.
        </p>
